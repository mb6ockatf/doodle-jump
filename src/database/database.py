...
class DatabaseConnection:
    def __init__(self):
        ...
        nickname TEXT UNIQUE NOT NULL, record INTEGER UNSIGNED DEFAULT 0);"""
    ...
    def insert(self, nickname: str, value: int):
        ...
        query = """SELECT record FROM main WHERE nickname = :nickname;"""
        result = self._execute(query, data)
        query = """INSERT OR REPLACE INTO main (nickname, record)
