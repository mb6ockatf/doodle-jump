...
class Colors:
    def __init__(self):
        ...
        self.dark = {"dark_purple": (49, 11, 71), "dark_grey": (57, 68, 79),
                     "dark_green": (14, 98, 67), "dark_yellow": (207, 184, 32)}
        self.light = {"light_blue": (104, 195, 248),
                      "light_green": (153, 232, 89)}
        self.vivid = {"blue": (40, 81, 184), "purple": (120, 18, 120),
                      "grey": (143, 143, 161), "yellow": (236, 234, 156),
                      "green": (24, 180, 24), "brown": (107, 59, 27),
                      "red": (170, 45, 14), "orange": (235, 118, 45)}
